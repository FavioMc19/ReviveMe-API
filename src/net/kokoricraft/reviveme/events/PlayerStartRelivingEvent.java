...
public class PlayerStartRelivingEvent extends Event implements Cancellable{
	...
	public PlayerStartRelivingEvent(Player player, Player reviver, DownedPlayer downed) {
